/**You will be given an array of objects (associative arrays in PHP) representing data about developers who have
 signed up to attend the next coding meetup that you are organising. The list is ordered according to who signed up first.
...
function getFirstPython(list) {
    for (let elem of list) {
        if (elem.language === "Python") {
            return elem.firstName + " " + elem.country;
        }
    }
